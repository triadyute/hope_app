...
export const AssessmentSelf15 = ({ navigation, route }) => {
  return (
      ...
      <View style={customStyles.innerWrapper}>
        ...
        <View style={customStyles.assessmentTextWrapper}>
          <CustomText style={customStyles.assessmentTxt}>
            Has your partner forced you to do anything of sexual nature without
            your consent?
          </CustomText>
        </View>
        <View style={customStyles.assessmentButtonWrapper}>
          <CustomButton
            onPress={() => {
              ...
              navigation.navigate('Assessment Self 16', {
