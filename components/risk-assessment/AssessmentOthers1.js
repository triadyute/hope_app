...
export const AssessmentOthers1 = ({ navigation, route }) => {
  let answers = 0;
      ...
      <View style={customStyles.innerWrapper}>
        ...
        <View style={customStyles.assessmentTextWrapper}>
          <CustomText style={customStyles.assessmentTxt}>
            Does your friend or family member constantly have to tell where he
            or she is?
          </CustomText>
        </View>
        <View style={customStyles.assessmentButtonWrapper}>
          <CustomButton
            onPress={() => {
              answers++;
              navigation.navigate('Assessment Others 2', {
