...
export const AssessmentSelf6 = ({ navigation, route }) => {
  return (
      ...
      <View style={customStyles.innerWrapper}>
        ...
        <View style={customStyles.assessmentTextWrapper}>
          ...
          <CustomText style={customStyles.assessmentTxt}>
            Controlled all the money in the home without discussing it with you,
            or refuse to provide money for your basic and/or personal needs?
          </CustomText>
        </View>
        <View style={customStyles.assessmentButtonWrapper}>
          <CustomButton
            onPress={() => {
              ...
              navigation.navigate('Assessment Self 7', {
