...
export const AssessmentOthers11 = ({ navigation, route }) => {
  return (
      ...
      <View style={customStyles.innerWrapper}>
        ...
        <View style={customStyles.assessmentTextWrapper}>
          <CustomText style={customStyles.assessmentTxt}>
            Are you afraid of your friend or family member’s partner, or does
            their partner make you feel nervous?
          </CustomText>
        </View>
        <View style={customStyles.assessmentButtonWrapper}>
          <CustomButton
            onPress={() => {
              ...
              navigation.navigate('Assessment End Others', {
          ...
          <CustomButton
            onPress={() => {
              if (route.params.answers === 0) {
                navigation.navigate('No Selected', {
                  choice: route.params.choice,
                  answers: route.params.answers,
                });
              } else {
